  ...
  describe Node do
    describe '#out_slots' do
      ...
      context 'when the node has a single "output" pair' do
        ...
        it 'sets the slot direction' do
          expect(node.out_slots.first.direction).to be(:out)
        end
        ...
        it 'sets the slot carrier' do
          expect(node.out_slots.first.carrier).to be(:gas)
        end
      end
      ...
      context 'when the node has gas and oil "output" pairs' do
        ...
        it 'sets the gas slot direction' do
          expect(node.out_slots.to_a.first.direction).to be(:out)
        end
        ...
        it 'sets the gas slot carrier' do
          expect(node.out_slots.to_a.first.carrier).to be(:gas)
        end

        it 'sets the oil slot direction' do
          expect(node.out_slots.to_a.last.direction).to be(:out)
        end
        ...
        it 'sets the oil slot carrier' do
          expect(node.out_slots.to_a.last.carrier).to be(:oil)
        end
      end
      ...
      context 'when updating the "output" data' do
        ...
        it 'adds slots which were added' do
          ...
          expect(new_slot.carrier).to be(:oil)
          expect(new_slot.share).to be(0.6)
        end
      end
    end
    ...
    describe '#in_slots' do
      ...
      context 'when the node has a single "input" pair' do
        ...
        it 'sets the slot direction' do
          expect(node.in_slots.first.direction).to be(:in)
        end
        ...
        it 'sets the slot carrier' do
          expect(node.in_slots.first.carrier).to be(:gas)
        end
      end
      ...
      context 'when the node has gas and oil "input" pairs' do
        ...
        it 'sets the gas slot direction' do
          expect(node.in_slots.to_a.first.direction).to be(:in)
        end
        ...
        it 'sets the gas slot carrier' do
          expect(node.in_slots.to_a.first.carrier).to be(:gas)
        end

        it 'sets the oil slot direction' do
          expect(node.in_slots.to_a.last.direction).to be(:in)
        end
        ...
        it 'sets the oil slot carrier' do
          expect(node.in_slots.to_a.last.carrier).to be(:oil)
        end
      end
    ...
    describe 'max_demand=' do
      ...
      it 'permits :recursive' do
        ...
        expect(node.max_demand).to be(:recursive)
        expect(node.errors[:max_demand]).to be_empty
      end
    end

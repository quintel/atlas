module Atlas
  class Dataset
    ...
    [ :buildings_insulation_employment_constant,
      ...
      :heat_households_ht_indoor_investment_costs_apartments_with_block_heating_eur,
      :heat_households_ht_indoor_investment_costs_apartments_without_block_heating_eur,
      :heat_households_ht_indoor_investment_costs_ground_level_houses_eur,
      ...
      :heat_households_mt_indoor_investment_costs_apartments_with_block_heating_eur,
      :heat_households_mt_indoor_investment_costs_apartments_without_block_heating_eur,
      :heat_households_mt_indoor_investment_costs_ground_level_houses_eur,
      :heat_exchanger_station_investment_costs_eur_per_kw,
      ...
      :heat_households_lt_indoor_investment_costs_apartments_with_block_heating_eur,
      :heat_households_lt_indoor_investment_costs_apartments_without_block_heating_eur,
      :heat_households_lt_indoor_investment_costs_ground_level_houses_eur,
      :heat_exchanger_station_investment_costs_eur_per_kw,

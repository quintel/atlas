module Atlas
  class Dataset
    ...
    [ :buildings_insulation_employment_constant,
      ...
      :heat_households_ht_indoor_investment_costs_with_block_heating_eur,
      :heat_households_ht_indoor_investment_costs_without_block_heating_eur,
      ...
      :heat_households_mt_indoor_investment_costs_with_block_heating_eur,
      :heat_households_mt_indoor_investment_costs_without_block_heating_eur,
      ...
      :heat_households_lt_indoor_investment_costs_with_block_heating_eur,
      :heat_households_lt_indoor_investment_costs_without_block_heating_eur,
